...
// HashKey is a hash key type
type HashKey struct {
	Type  ObjectType
	Value uint64
}

// HashKey returns a HashKey for Boolean values
...
// HashKey returns a HashKey for Integer values
func (i *Integer) HashKey() HashKey {
	return HashKey{Type: i.Type(), Value: uint64(i.Value)}
}

// HashKey returns a HashKey for String values
...
// Type returns object type of hash
func (h *Hash) Type() ObjectType { return HASH_OBJ }

// Inspect returns hash as string
...
// Hashable is a hashable interface
